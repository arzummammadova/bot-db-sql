...
--dostu hemin suallari cavablandirir ve user ile dostunun cavalari muqayise olunur

--onda user  cedvelinden yaradiram texmini  username uniq olsun lazim olsa artirari first_name last_name
create table users(
